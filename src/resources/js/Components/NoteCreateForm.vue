          ...
          <v-row>
            ...
            <v-col cols="12" lg="6">
              ...
              <v-autocomplete v-model="form.category" hide-details="auto" :items="items.category" density="compact"
                ...
                :error-messages="form.errors.category" required autocomplete="username" item-title="name"
                item-value="id" @input="form.errors.category = null">
            ...
            <v-col v-if="form.category === 3" cols="12" lg="6">
              ...
              <template v-if="allDay === false">
                <v-text-field v-model="form.starts" class="mt-3" label="Starts" hide-details="auto"
                  type="datetime-local" density="compact" placeholder="Enter Desctiption" variant="outlined"
                ...
                <v-text-field v-model="form.ends" class="mt-3" label="Ends" hide-details="auto" type="datetime-local"
                  ...
                  :error="Boolean(form.errors.ends)" :error-messages="form.errors.ends" required autocomplete="username"
